...
app.use(cors({credentials:true,origin:'https://afs-final-backend.vercel.app/'}));
...
const conformationEmail = (email)=>{
  ...
  var mailOptions = {
    ...
    text: 'Your email is successfull registered on MyBlog App'
  };
